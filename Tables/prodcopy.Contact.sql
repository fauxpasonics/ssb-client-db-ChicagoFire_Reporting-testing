...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Contact__copyloa__286302EC] DEFAULT (getdate()),
[name_email_hash] [binary] (32) NULL
)
GO
ALTER TABLE [prodcopy].[Contact] ADD CONSTRAINT [PK__Contact__7126F91D35945B0E] PRIMARY KEY CLUSTERED  ([contactid])
GO
