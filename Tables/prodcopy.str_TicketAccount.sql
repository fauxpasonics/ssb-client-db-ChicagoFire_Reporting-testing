CREATE TABLE [prodcopy].[str_TicketAccount]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Ticke__copyl__35BCFE0A] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[str_TicketAccount] ADD CONSTRAINT [PK__str_Tick__8CA651070AF20888] PRIMARY KEY CLUSTERED  ([str_ticketaccountid])
GO
