...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Contact__copyloa__2B3F6F97] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Contact] ADD CONSTRAINT [PK__Contact__7126F91D470BD881] PRIMARY KEY CLUSTERED  ([contactid])
GO
